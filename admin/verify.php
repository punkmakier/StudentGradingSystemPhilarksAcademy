...
if (isset($_POST['resend'])) {
      ...
      $query = "UPDATE useraccounts SET CODE='$code' WHERE `ACC_EMAIL`='{$_SESSION['email']}'";
          $mydb->setQuery($query);
...
<?php
  ...
  $sql = "SELECT * FROM `useraccounts` WHERE `CODE`='{$_POST['code']}'";
  $mydb->setQuery($sql);
  ...
  <div class="col-md-4 col-md-offset-4">
    ...
    <div class="modal-footer">
      <input type="hidden" class="hide" name="token" value="<?php echo $result->ACCOUNT_ID;?>">
