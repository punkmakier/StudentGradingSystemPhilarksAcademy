            ...
            <h1 class="page-header">Edit Teacher</h1>
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                         ...
                         <input class="form-control input-sm" id="INST_NAME" name="INST_NAME" placeholder=
                            "Teacher Full Name" type="text" value="<?php echo $inst->INST_NAME ; ?>">
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                        <input name="deptid" type="hidden" value="">
                         <input class="form-control input-sm" id="INST_Username" name="INST_Username" placeholder=
                            "Username" type="text" value="<?php echo $inst->INST_Username ; ?>">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                        <input name="deptid" type="hidden" value="">
                         <input class="form-control input-sm" id="INST_Password" name="INST_Password" placeholder=
