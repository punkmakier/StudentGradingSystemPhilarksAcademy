            ...
            <h1 class="page-header">Add New Schedule</h1>
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                        <select id="sched_day" name="sched_day" class="form-control input-sm">
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                         ...
                         <input class="form-control input-sm" id="SECTION" name="SECTION" placeholder="Section" type="number" pattern="[0-9]{1}" value="">
                      </div>
                    </div>
                  </div>
