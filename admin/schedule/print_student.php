...
require_once("../../include/initialize.php");  
 $schedID = isset($_POST['id']) ?  $_POST['id'] : '';
  ...
  $mydb->setQuery($sql);
   ...
   if ($max_sched > 0) {
     // code...
      ...
      $gradeID =$singleSchedule->COURSE_ID;
   }else{
     $grade_level ='none';
      $gradeID ='0';
   }
...
<div class="wrapper">
  ...
  <section class="invoice">
    ...
    <div class="row"><h2 align="center">List Of Students Enrolled</h2>
    <h5 align="center">
            ...
            <?php
                $tot = 0; 
                 ...
                 $sql ="SELECT * FROM `schoolyr` sy, `tblstudent`  s ,`course` c 
                        WHERE sy.`IDNO`=s.`IDNO` AND s.`COURSE_ID`=c.`COURSE_ID` AND c.`COURSE_ID` ='{$gradeID}'";
              ...
              <tfoot>
              <tr>
                <td colspan="7" align="right"><h2>Total Number of Student/s : </h2></td><td><h2><?php echo   $tot ; ?></h2></td>
              </tr>
            </tfoot>
          </table> 
        <!-- /.col --> 
