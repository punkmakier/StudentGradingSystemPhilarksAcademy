...
?>
 <div class="row">
      <div class="col-lg-12">
       	 <div class="col-lg-6">
            <h1 class="page-header">Grade Level  <a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> New</a>  </h1>
       		</div>
       		<div class="col-lg-6" >
				  ...
				  <tbody>
				  	<?php 
						...
						foreach ($cur as $result) {
				  		...
				  		echo '<tr>';
				  		echo '<td width="2px" >' . $result->COURSE_ID.'</td>';
